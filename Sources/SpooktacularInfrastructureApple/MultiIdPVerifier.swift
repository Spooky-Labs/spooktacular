...
public enum IdPError: Error, LocalizedError, Sendable {
    ...
    public var recoverySuggestion: String? {
        ...
        case .issuerNotRegistered(let iss):
            "Add an entry for `\(iss)` to SPOOKTACULAR_IDP_CONFIG, then restart. The registry loads at startup — runtime registration via the admin API is a separate endpoint."
        case .unrecognizedTokenFormat:
