...
public enum ReservationError: Error, LocalizedError, Sendable, Equatable {
    ...
    public var recoverySuggestion: String? {
        switch self {
        case .contended:
            "Retry after a short backoff. Sustained contention indicates the tenant's quota is saturated across many controllers simultaneously — consider raising SPOOKTACULAR_RATE_LIMIT or widening the tenant quota."
        }
    }
}
