...
extension Spooktacular {
    ...
    struct BreakGlass: AsyncParsableCommand {
        ...
        /// `SPOOKTACULAR_BREAKGLASS_PUBLIC_KEYS_DIR` to trust the
        ...
        struct Keygen: AsyncParsableCommand {
            static let configuration = CommandConfiguration(
                ...
                discussion: """
                    ...
                    agent's SPOOKTACULAR_BREAKGLASS_PUBLIC_KEYS_DIR.
            ...
            func run() async throws {
                ...
                print(Style.dim("  Public:  \(publicKeyPath) (distribute into each agent's SPOOKTACULAR_BREAKGLASS_PUBLIC_KEYS_DIR)"))
            }
